...
public class TelaBuscaProdutoCopa extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        setTitle("Busca de Produto da Copa");
        setResizable(false);
        ...
        jLabelTitulo.setText("Produtos da Copa");
        ...
        jTableDados.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {},
            new String [] { "ID", "Descrição", "Valor", "Cód. Barras", "Status" }
        ) {
        ...
        jCBFiltro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ID", "Descrição", "codigo_barra" }));
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            TelaBuscaProdutoCopa dialog = new TelaBuscaProdutoCopa(new javax.swing.JFrame(), true);
